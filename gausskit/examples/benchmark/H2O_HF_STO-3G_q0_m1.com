%chk=H2O_HF_STO-3G_q0_m1_stab.chk
#p HF/STO-3G stable=opt scf=novaracc guess=mix int=superfinegrid

H2O — HF/STO-3G   q=0 m=1   [1/3: Stability]
...
--Link1--
%oldchk=H2O_HF_STO-3G_q0_m1_stab.chk
%chk=H2O_HF_STO-3G_q0_m1.chk
#p HF guess=read chkbasis geom=allcheck Opt Freq int=superfinegrid scf=xqc

H2O — HF/STO-3G   q=0 m=1   [2/3: Opt+Freq]

--Link1--
%oldchk=H2O_HF_STO-3G_q0_m1.chk
%chk=H2O_HF_STO-3G_q0_m1_stab.chk
#p HF stable=opt guess=read chkbasis geom=allcheck int=superfinegrid

H2O — HF/STO-3G   q=0 m=1   [3/3: Stability]
